            ...
            <div className="flex flex-col bg-white">
                <div className="p-4 border-b border-gray-100">
                    <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider flex items-center gap-2">
                        <Loader2 className={`w-3 h-3 ${status.pdfUploaded ? 'animate-spin text-blue-600' : 'text-gray-400'}`} />
                        RFP 분석 중...
                    </h3>
                </div>
                <div className="p-4 space-y-3">
                    <div className="flex items-center gap-2 text-xs">
                        ...
                        <span className={status.pdfUploaded ? 'text-gray-900 font-medium' : 'text-gray-400'}>RFP 업로드 완료</span>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="overflow-y-auto max-h-[400px] animate-in slide-in-from-top-1 duration-200">
                    <div className="p-4 space-y-4 text-xs">
                        ...
                        <div className="bg-blue-50/50 p-3 rounded-lg border border-blue-100/50">
                            <span className="text-[10px] text-blue-600 font-bold uppercase tracking-wider block mb-1">사업명</span>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block mb-0.5">예산</span>
                                <span className="font-semibold text-gray-900">{overviewData.budget || '-'}</span>
                            </div>
                            <div className="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block mb-0.5">기간</span>
                        ...
                        {overviewData.project_summary && (
                            <div className="space-y-1.5">
                                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block">사업 개요</span>
                                <p className="text-gray-700 leading-relaxed bg-white border border-gray-100 p-3 rounded-lg shadow-sm">
                                    {overviewData.project_summary}
                                </p>
                            </div>
                        )}
